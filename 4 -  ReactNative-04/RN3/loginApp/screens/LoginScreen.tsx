...
export default function LoginScreen({ navigation }: Props) {
  ...
  const handleGoogleLogin = () => {
    const clientId = "757087668459-rert444tns0hces8h72lurssiq41en5v.apps.googleusercontent.com";
  ...
  return (
    ...
    >
      ...
      >
        <View style={{ position: "relative", width: containerWidth, alignSelf: "center" }}>
          <View
            style={{
              position: "absolute",
              top: 5,
